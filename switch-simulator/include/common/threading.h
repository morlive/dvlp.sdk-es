...
#ifndef SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_THREADING_H
#define SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_THREADING_H
...
#endif /* SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_THREADING_H */
