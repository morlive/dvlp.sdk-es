...
#ifndef SDK_ES_SWITCH_SIMULATOR_DRIVERS_INCLUDE_ETHERNET_DRIVER_H
#define SDK_ES_SWITCH_SIMULATOR_DRIVERS_INCLUDE_ETHERNET_DRIVER_H
...
#endif /* SDK_ES_SWITCH_SIMULATOR_DRIVERS_INCLUDE_ETHERNET_DRIVER_H */
