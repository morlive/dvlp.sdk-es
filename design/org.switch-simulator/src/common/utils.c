...
const char* status_to_string(status_t status) {
    switch (status) {
        ...
        case STATUS_RESOURCE_UNAVAILABLE:
            return "Resource unavailable";
        case STATUS_RESOURCE_EXCEEDED:
            return "Resource exceeded";
        case STATUS_INVALID_PORT:
            return "Invalid port";
        case STATUS_MODULE_NOT_INITIALIZED:
            return "Module not initialized";

        // Обработка ошибок пакетов
        case -203: // ERROR_PACKET_MALFORMED:
            return "Malformed packet";
        case -204: // ERROR_PACKET_TOO_BIG:
            return "Packet too big";
        case -205: // ERROR_INVALID_HEADER:
            return "Invalid header";
        case -206: // ERROR_INVALID_CHECKSUM:
            return "Invalid checksum";
        case -207: // ERROR_INVALID_OPTION:
            return "Invalid option";
        case -208: // ERROR_CANNOT_FRAGMENT:
            return "Cannot fragment";
        case -209: // ERROR_MTU_TOO_SMALL:
            return "MTU too small";
        case -210: // ERROR_NOT_IMPLEMENTED:
            return "Not implemented";
        case -211: // ERROR_ARP_PENDING:
            return "ARP pending";
        case -212: // ERROR_NULL_POINTER:
            return "Null pointer";
        case -213: // FRAGMENT_REASSEMBLY_TIMEOUT:
            return "Fragment reassembly timeout";
        case -214: // ERROR_PACKET_OPERATION_FAILED:
            return "Packet operation failed";
        case -215: // ERROR_REASSEMBLY_IN_PROGRESS:
            return "Reassembly in progress";
        case -216: // ERROR_TTL_EXCEEDED:
            return "TTL exceeded";
        case -217: // ERROR_ENTRY_NOT_FOUND:
            return "Entry not found";
        case -218: // ERROR_PENDING_RESOLUTION:
            return "Pending resolution";

        // Обработка других кодов ошибок из вашего enum
        case -219: // ERROR_INVALID_STATE:
            return "Invalid state";
        case -220: // ERROR_INVALID_PACKET:
            return "Invalid packet";

        // Добавьте другие коды состояний по мере необходимости

        default: {
            // Для неизвестных значений статуса возвращаем общее описание с числом
            static char buffer[64];
            snprintf(buffer, sizeof(buffer), "Unknown status code (%d)", status);
            return buffer;
        }
    }
}
