...
void setup_test_environment() {
    ...
    mac_addr_t neighbor1_mac = {0x00, 0xAA, 0xBB, 0xCC, 0xDD, 0x01};
    
    arp_table_add(&g_arp_table, &neighbor1, neighbor1_mac);
    
    ip_addr_t neighbor2 = {192, 168, 2, 100};
    mac_addr_t neighbor2_mac = {0x00, 0xAA, 0xBB, 0xCC, 0xDD, 0x02};
    
    arp_table_add(&g_arp_table, &neighbor2, neighbor2_mac);
    
    ip_addr_t neighbor3 = {10, 0, 0, 2};
    mac_addr_t neighbor3_mac = {0x00, 0xAA, 0xBB, 0xCC, 0xDD, 0x03};
...
uint32_t process_ipv4_packet(packet_t *packet, uint32_t *egress_port, mac_addr_t *next_hop_mac) {
...
void test_direct_routing() {
    ...
    mac_addr_t src_mac = {0x00, 0xAA, 0xBB, 0xCC, 0xDD, 0x01};
    mac_addr_t dst_mac = {0x00, 0x11, 0x22, 0x33, 0x44, 0x00}; // Interface 0 MAC
...
void test_ttl_expiry() {
    ...
    ip_addr_t dst_ip = {172, 16, 1, 1};
    mac_addr_t src_mac = {0x00, 0xAA, 0xBB, 0xCC, 0xDD, 0x01};
    mac_addr_t dst_mac = {0x00, 0x11, 0x22, 0x33, 0x44, 0x00};
