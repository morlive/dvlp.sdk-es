...
typedef enum {
   ...
   BSP_ERROR_INIT_FAILED,              // <- ДОБАВЬТЕ ЭТУ СТРОКУ
...
// -----------------------------------------------------------------------------
// 14. Helper functions for configuration
// -----------------------------------------------------------------------------
 ...
 * @return BSP_SUCCESS on success, error code otherwise
 */
