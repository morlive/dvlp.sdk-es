...
typedef enum {
    ...
    BSP_ERROR_PORT_NOT_FOUND,        // Новый error code
    BSP_ERROR_CONFIG_LOCKED,         // Новый error code
    BSP_ERROR_HARDWARE_FAULT,        // Новый error     
    BSP_ERROR_UNKNOWN
} bsp_error_t;
...
// Helper function для макроса валидации
