...
#ifndef SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_TYPES_H
#define SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_TYPES_H
...
#endif   /* SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_TYPES_H */
