...
#ifndef SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_ERROR_CODES_H
#define SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_ERROR_CODES_H
...
#endif /* SDK_ES_SWITCH_SIMULATOR_INCLUDE_COMMON_ERROR_CODES_H*/
