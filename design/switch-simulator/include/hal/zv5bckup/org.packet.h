...
///////// option 2:
///////packet_buffer_t* packet_alloc(uint32_t size) {
///////    return packet_buffer_alloc(size);
///////}
///////// option 3:
///////packet_buffer_t* (*packet_alloc)(uint32_t size) = packet_buffer_alloc;
///////
...
// * @param eth_header Pointer to store extracted header
// * @return status_t STATUS_SUCCESS on success
// */
////status_t packet_get_ethernet_header(packet_buffer_t *packet, ethernet_header_t *eth_header);
//// В include/hal/packet.h измените:
//// status_t packet_get_ethernet_header(const packet_t *packet, ethernet_header_t **eth_header);
...
// * @return status_t STATUS_SUCCESS on success
// */
//status_t packet_get_vlan_id(packet_t *packet, vlan_id_t *vlan_id);
